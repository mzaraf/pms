...
urlpatterns = [
    ...
    path('get_units_by_department/', views.get_units_by_department, name='get_units_by_department'),
    ...
    path('hod_download_appraisal/', HodViews.hod_download_appraisal, name='hod_download_appraisal'),
